            ...
            <div class="sidebar-item mb-20">
              <div class="summary-payment">
                ...
                <h3> <strong> Booking Summary</strong> </h3>
                  ...
                  <div>
                  <h4 class="no-mb"><?php if(isset($packageName)) echo $packageName; ?></h4>
                  <h5>E-Mail : <?php if(isset($_SESSION["useremail"])) echo $_SESSION["useremail"]; ?> &nbsp; Travellin Date : <?php if(isset( $_SESSION['travelUserDate'])) echo  $_SESSION['travelUserDate']; ?></h5>
                  <h5><?php if(isset($_SESSION["usernumber"])) echo "Mobile No. :".$_SESSION["usernumber"]; ?> &nbsp; Package Date : <?php if(isset( $_SESSION['packageDate'])) echo  $_SESSION['packageDate']; ?></h5>
                  <h4>Adults(<?php if(isset( $_SESSION["adultCount"])) echo  $_SESSION["adultCount"]; else echo "0"; ?>) &nbsp; Childs(<?php if(isset( $_SESSION["childCount"])) echo  $_SESSION["childCount"]; else echo "0"; ?>) </h4>
                </div>
                <div class="bb2 mb-30"></div>
                <table class="table table-bordered table-striped mb-30">
                  <tr>
                    <td>Base Fair / Unit</td>
                    <td class="center text-bold text-success"><?php if(isset($price)) echo $price; ?></td>
                  </tr>
                  <tr>
                    <td>Total Passengers</td>
                    <td class="center text-bold text-success"><?php if(isset($_SESSION["totCount"])) echo $_SESSION["totCount"]; ?></td>
                  </tr>
                  <tr>
                    <td>Total Price</td>
                    <td class="center text-bold text-success"><?php if(isset($_SESSION["grossAmount"])) echo $_SESSION["grossAmount"]; ?></td>
                  </tr>
                  <tr>
                    <td>Tax</td>
                    <td class="center text-bold text-success">0%</td>
                  </tr>
                </table>
                <div class="bb2 mb-20"></div>
                <span class="left">You Pay:</span> <span class="right text-success text-bold font24"><?php if(isset($_SESSION["grossAmount"])) echo $_SESSION["grossAmount"];?> </span>
                <div class="clear mb-10"></div>
              </div>
            </div>
